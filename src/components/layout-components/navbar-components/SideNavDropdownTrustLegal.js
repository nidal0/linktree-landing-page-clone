...
const SideNavDropdownTrustLegal = (props) => {
    ...
    <React.Fragment>
      ...
      <Collapse in={open} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <SideNavDropdownItem href="/" text="Terms & Conditions" />
          <SideNavDropdownItem href="/" text="Privacy Policy" />
          <SideNavDropdownItem href="/" text="Trust Centre" />
        </List>
      </Collapse>
    </React.Fragment>
  );
...
export default SideNavDropdownTrustLegal;
