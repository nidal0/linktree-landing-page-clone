...
const SideNavDropdownPartnerships = (props) => {
    ...
    <React.Fragment>
      ...
      <Collapse in={open} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <SideNavDropdownItem href="/" text="Linktree fro Enterprise" />
          <SideNavDropdownItem href="/" text="Charities" />
          <SideNavDropdownItem href="/" text="Linktree Ambassador" />
        </List>
      </Collapse>
    </React.Fragment>
  );
...
export default SideNavDropdownPartnerships;
