    ...
    <React.Fragment>
      ...
      <Collapse in={open} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <SideNavDropdownItem href="/" text="Blog" />
          <SideNavDropdownItem href="/" text="About" />
          <SideNavDropdownItem href="/" text="Press" />
          <SideNavDropdownItem href="/" text="Careers" />
          <SideNavDropdownItem href="/" text="Social Good" />
          <SideNavDropdownItem href="/" text="Contact" />
        </List>
      </Collapse>
    </React.Fragment>
  );
...
export default SideNavDropdownCompany;
